...
class TransactionClassifier:
    def __init__(self, parquet_path):
        ...
        self.rule_name = 'Ext Settlement Summary_Add 1 day vs Payment Detail_Refund_1'
    ...
    def prepare_features(self, df):
        ...
        categorical_cols = ['TransactionType', 'BankTrfRef', 'CR_DR']
        ...
        numerical_cols = ['Amount', 'post_day_of_week', 'post_day_of_month', 'post_month', 'post_year']
    ...
    def save_model(self, results, output_dir='model_outputs/settlement_classifier'):
...
def main():
    ...
    parquet_path = "data_cache/batch_14238344.parquet"  # Update this path as needed
