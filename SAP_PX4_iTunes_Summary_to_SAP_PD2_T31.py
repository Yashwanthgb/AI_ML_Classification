...
class TransactionClassifier:
    def __init__(self, parquet_path):
        ...
        self.rule_name = 'SAP PX4 iTunes Summary to SAP PD2 T31'
    ...
    def prepare_features(self, df):
        ...
        # Convert DocumentDate to datetime features
        X['DocumentDate'] = pd.to_datetime(X['DocumentDate'])
        X['doc_day_of_week'] = X['DocumentDate'].dt.dayofweek
        X['doc_day_of_month'] = X['DocumentDate'].dt.day
        X['doc_month'] = X['DocumentDate'].dt.month
        X['doc_year'] = X['DocumentDate'].dt.year
        
        # Drop original DocumentDate column
        X = X.drop('DocumentDate', axis=1)
        ...
        for col in X.columns:
            ...
            if null_count > 0:
                ...
                if col in ['doc_day_of_week', 'doc_day_of_month', 'doc_month', 'doc_year']:
        ...
        date_cols = ['doc_day_of_week', 'doc_day_of_month', 'doc_month', 'doc_year']
    ...
    def save_model(self, results, output_dir='model_outputs/itunes_summary'):
